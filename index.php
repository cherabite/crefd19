...
<fieldset>
        <p>
            <label>إستراد قاعدة البيانات:</label>
            
        </p>
<a href="import_exel.php" target="_blank"> إستراد   </a>
    </fieldset>
</div>
...

{
	...
	for ($i=1;$i<28;$i++)
	{
		...
		$field= substr($field,1);
            ...
            VALUES ( '$row[33]','$row[29]','$field','$row[$i]','','') " ;
	...
	// inserer nbr_niv dans tab_total
	 $sqll = "INSERT  INTO tab_total (nbr_classes,nbr_niv,nbr_cond_par_centre,etab,cod_etab,directeur,pole,wil)
            VALUES ( '$row[34]','$nbr_niv','$row[0]','$row[29]','$row[33]','$row[32]','$row[30]','$row[31]') " ;
