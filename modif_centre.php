...
<title>عالم مطورى الويب لتعليم التصميم والبرمجة </title>
...
if ( isset($_POST['etablissent']))
 {
  if($_POST['etablissent']!="")
  {
     $g=$_POST['code_etab'];
	  ...
	  $directeur=$_POST['directeur'];$nbr_classes=$_POST['nbr_classes'];$n1=$_POST['104'];$n2=$_POST['204'];$n3=$_POST['304'];$n4=$_POST['404'];$n5=$_POST['122'];$n6=$_POST['124'];$n7=$_POST['212'];
	  $n8=$_POST['213'];$n9=$_POST['214'];$n10=$_POST['216'];$n11=$_POST['218'];$n12=$_POST['237'];$n13=$_POST['312'];$n14=$_POST['313'];$n15=$_POST['314'];$n16=$_POST['316'];$n17=$_POST['318'];$n18=$_POST['337'];
     mysql_query("update tab_stat set etablissent='$ff',directeur='$directeur',nbr_classes='$nbr_classes', tab_stat.104='$n1',tab_stat.204='$n2',tab_stat.304='$n3',tab_stat.404='$n4',tab_stat.122='$n5',tab_stat.124='$n6',tab_stat.212='$n7',tab_stat.213='$n8',tab_stat.214='$n9',tab_stat.216='$n10',tab_stat.218='$n11',tab_stat.237='$n12',tab_stat.312='$n13',tab_stat.313='$n14',tab_stat.314='$n15',tab_stat.316='$n16',tab_stat.318='$n17',tab_stat.337='$n18'  where code_etab='$g'");
		            ...
		            if($row1[$i]>0)
		             {
                         ...
                         VALUES ( '$row1[22]','$row1[19]','$field','$row1[$i]') " ;
		                      ...
		                      if($row3[$i]>0)
		                            {
			                          $field=mysql_field_name($r_ins, $i);	
                                       ...
                                       VALUES ( '$row3[22]','$row3[19]','$field','$row3[$i]') " ;
			                      ...
			                      if($rowu[$i]>0)
		                             {
			                            $field=mysql_field_name($r_ins, $i);
		                	             ...
		                	             if( $total_tab_niv2>0)
										 {
										  ...
										  {
										  $sql_t = "INSERT  INTO tab_niv (cod_etab ,etab ,niv,nbr_cond_par_niv )
                                          VALUES ( '$rowu[22]','$rowu[19]','$field','$rowu[$i]') " ;
			         ...
			         $select_a = "SELECT * FROM tab_stat where code_etab='$k' ";
			          ...
			          $row1 = mysql_fetch_row($result_a); 
	                      ...
	                      for ($i=1;$i<19;$i++)
							...
							mysql_query("UPDATE tab_total SET directeur='$row1[21]',etab='$row1[19]',nbr_classes='$row1[23]',nbr_niv='$nbr_niv',nbr_cond_par_centre='$row1[0]' where cod_etab='$k' ");	   
	                           }
...
//********************************
	    ...
	    if( $row = mysql_fetch_row($result_b))
		{
          ...
          //$conv_com_secrit//
           ...
           $briellon=$row[22]*12 ;
            $etiquette=$row[22];
           $feille_examen=$row[22]*7 ;
           $liste_cond_par_classe=$row[20]*2 ;
           $listing=$row[21] ;
           $etiquette=$row[22];
		   if(($nb_sal%8==0)){
			   $ammana=(int)($nb_sal /8);
		   ...
		   if(($nb_sal%10==0)){
			   ...
			   $commun=(int)($nb_sal /10)+1;
					   ...
					   if($ammana > 8){$ammana=8;} 
					   if($travails > 5){$travails=5;}
